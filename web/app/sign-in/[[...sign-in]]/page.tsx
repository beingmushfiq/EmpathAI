...
export default function SignInPage() {
  return (
    <div className="flex h-screen items-center justify-center bg-[hsl(240,15%,8%)] relative overflow-hidden">
      <div className="orb orb-brand absolute w-[400px] h-[400px] top-1/4 left-1/4 opacity-40 mix-blend-screen animate-pulse-slow"></div>
      <div className="orb orb-accent absolute w-[300px] h-[300px] bottom-1/4 right-1/4 opacity-30 mix-blend-screen"></div>
        ...
        <SignIn 
          appearance={{
            elements: {
              ...
              formFieldInput: "bg-white/[0.04] border-white/[0.08] text-white rounded-xl focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-colors",
